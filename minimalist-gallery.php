...
add_action('admin_menu', 'minimalist_gallery_menu');

function minimalist_gallery_menu() {
    add_submenu_page('options-general.php', 'minimalist-gallery', 'Minimalist Gallery', 'manage_options', 'minimalist-gallery-menu', 'minimalist_gallery_options');
}

function minimalist_gallery_options() {
    ?>
<div class="wrap">
<h2>Minimalist Gallery</h2>
    
<table class="form-table"><tbody>
    <tr valign="top">
        <th scope="row"><label for="width"><?php echo __('Width', "minimalist-gallery") ?></label></th>
        <td><input name="width" type="text" id="width" value="500" class="regular-text">
        <span class="description">px</span></td>
    </tr>
    <tr valign="top">
        <th scope="row"><label for="height"><?php echo __('Height', "minimalist-gallery") ?></label></th>
...
function minimalist_gallery_init() {
    wp_enqueue_script('jquery');
    $plugin_dir = basename(dirname(__FILE__));
    load_plugin_textdomain("minimalist-gallery", false, $plugin_dir.'/languages/');
}
add_action('init', 'minimalist_gallery_init');
...
function gallery_shortcode_mg($attr) {
    ...
    $output .= '
        <div class="gallery-navigation">
            <span style="float: left;"><a href="javascript:void(0);" onclick="galleryPrev();" class="prev">'.__("&laquo; Previous", "minimalist-gallery").'</a></span>
            <span style="text-align: center;"><span class="current">0</span>/<span class="total">0</span></span>
            <span style="float: right;"><a href="javascript:void(0);" onclick="galleryNext();" class="next">'.__("Next &raquo;", "minimalist-gallery").'</a></span>
        </div>
